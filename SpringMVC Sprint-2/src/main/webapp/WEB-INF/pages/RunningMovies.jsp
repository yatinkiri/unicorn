...
small.text-muted {
  font-family:courier,courier-new,monospace;
    ...
    <div id="myModal" class="modal fade">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Save changes</button>
                        ...
                        <div class="row">    
                          ...
                          <div class="col-sm-2">
                            <a href="#" class="pull-right"><button class="btn btn-success btn-lg" onclick="display('a_${o.movieName}');"><img src="${o.img}"  class="img-rounded"></button></a>
                          </div> 
                          <div class="col-sm-10" style="display:none;" id="a_${o.movieName}">
					        <form id="cascade" action="/SpringMVC/cascade" method="post" >
							<select class="form-control" id="hello" onchange="displayTime('aa_${o.movieName}',this.value);">
							<option value='default'>Select Date!</option>
							<c:forEach var="i" items="${o.dates}">
							 <option value ="i_${o.movieName}"><c:out value="${i}"/></option>
							</c:forEach>
                            </select>
                            </form>
					      </div>
					      <br>
					       ...
					       <select class="form-control" id="hello2" onchange="displayTime(this.value);">
							<option value='default'>Select Date!</option>
							<c:forEach var="i" items="${o.dates}">
							 <option value ="1" id><c:out value="${i}"/></option>
							</c:forEach>
                            </select>
					      </div>
        ...
        /* function displayTime(field,value) {
       	 /*  DispWin = window.open('','NewWin', 'toolbar=no,status=no,width=300,height=200')
       	  message = "<ul><li><b>NAME: </b>" + document.form1.yourname.value;
       	  message += "<li><b>ADDRESS: </b>" + document.form1.address.value;
       	  message += "<li><b>PHONE: </b>" + document.form1.phone.value + "</ul>";
        ...
        function populate(field,name) {
        	System.out.println("heyakldk");
        	var xmlhttp;
        	...
        	xmlhttp.open("GET", "populate?field=" + field + "&name=" +name , false);
        	xmlhttp.send();
        	} 
        </script>
